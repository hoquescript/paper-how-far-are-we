...
# Provider configuration mapping language to parser and AST traversal function
providers = {
    "cpp": {
...
def process_csv_files(input_dir, output_dir):
    ...
    for csv_file in glob(input_dir + '/**/*.csv', recursive=True):
        ...
        data['ast'] = data['code'].apply(lambda code: generate_ast_sequence(code, language))
        
        # Remove rows where AST generation failed
